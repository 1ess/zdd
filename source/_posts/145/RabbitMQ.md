---
title: RabbitMQ
featured_image: https://cdn.zhangdd.tech/blogImg/Blog145.webp
date: 2020-05-14
---
...
![](https://cdn.zhangdd.tech/contentImg/mq/workflow-rabbitmq.webp)

### 交换器(exchange)
消息不会直接发布到队列，通常生产者向交换器发送消息。交换器负责在 bindings 和 routing keys 的帮助下将消息路由到不同的队列。bindings 是队列和交换器之间的链接。

![](https://cdn.zhangdd.tech/contentImg/mq/exchanges-bindings-routing-keys.webp)
...
![](https://cdn.zhangdd.tech/contentImg/mq/exchanges-topic-fanout-direct.webp)

---
title: 设计模式-抽象工厂
featured_image: https://cdn-fawn.vercel.app/blogImg/Blog208.png
date: 2022-02-15
---
...
![](https://cdn-fawn.vercel.app/contentImg/designpattern/dp2-1.png)

接下来，我们需要声明抽象工厂，该类中包含系列中所有产品构造方法的接口。
![](https://cdn-fawn.vercel.app/contentImg/designpattern/dp2-2.png)

**对于系列产品的每个变体，我们都将基于抽象工厂接口创建不同的工厂类，每个工厂类都只能返回特定类别的产品**。

## 抽象工厂模式 UML
***  
![](https://cdn-fawn.vercel.app/contentImg/designpattern/dp2-3.png)

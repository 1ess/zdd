...
featured_image: https://cdn.zhangdd.tech/blogImg/Blog10.webp
date: 2018-07-02
---
...
## 存储器的层次结构
***  
![](https://cdn.zhangdd.tech/contentImg/memory/memory-hierarchy.webp)

![](https://cdn.zhangdd.tech/contentImg/memory/memory-hierarchy-time.webp)

## SRAM
***  
![](https://cdn.zhangdd.tech/contentImg/memory/SRAM.webp)

上图是 6 晶体管 SRAM 的一个单元。核心是 4 个晶体管 M1-M4，它们组成两个交叉耦合的反相器。它们有两个稳定的状态，分别代表 0 和 1。

## DRAM
***  
![](https://cdn.zhangdd.tech/contentImg/memory/DRAM.webp)

动态 RAM 比静态 RAM 要简单得多。上图展示了一种普通 DRAM 的结构。它只含有一个晶体管和一个电容器。

## 主存
***  
![](https://cdn.zhangdd.tech/contentImg/memory/RAM.webp)
